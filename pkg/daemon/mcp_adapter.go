...
// It looks up deployed agents in ~/.agentscale/agents/ directory.
...
func (d *daemonServerGetter) GetAgentInstance(agentID string) (mcp.AgentInstance, error) {
	...
	// Look up deployed agent in ~/.agentscale/agents/{agentID}
	home, err := os.UserHomeDir()
	if err != nil {
		return nil, fmt.Errorf("get home dir: %w", err)
	}

	agentPath := filepath.Join(home, ".agentscale", "agents", agentID)
